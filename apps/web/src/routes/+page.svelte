  ...
  <div class="mx-auto grid w-full max-w-6xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:py-24">
    <div>
      ...
      <div class="mt-8 flex flex-wrap items-center gap-3">
        <a
          class="inline-flex items-center rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-700"
          href="/work"
        >
          Explore work
        </a>
        <a
          class="inline-flex items-center rounded-xl border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-800 transition hover:border-slate-400 hover:text-slate-900"
          href="/contact"
        >
          Start a project
        </a>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
      ...
      <Card class="sm:col-span-2" variant="contrast">
...
<Section eyebrow="Featured Work" title="Selected case studies" containerClass="py-16">
  <a slot="actions" class="text-sm font-semibold text-slate-700 hover:text-slate-900" href="/work">
    View all projects
  </a>

  <div class="grid gap-5 md:grid-cols-3">
    {#each featuredWork as item}
      <a class="block" href={`/work/${item.slug}`}>
...
>
  <a slot="actions" class="text-sm font-semibold text-slate-700 hover:text-slate-900" href="/services">
    See service details
  </a>
...
<Section containerClass="py-16">
  <Card padding="lg" class="rounded-3xl">
    ...
    <div class="mt-8 flex flex-wrap gap-3">
      <a class="rounded-xl bg-emerald-600 px-6 py-3 text-sm font-semibold text-white hover:bg-emerald-500" href="/contact">
        Book a discovery call
      </a>
      <a class="rounded-xl border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-800 hover:border-slate-400" href="/work">
        Review case studies
      </a>
    </div>
  </Card>
...
>
  ...
  <div slot="footer" class="flex flex-wrap justify-end gap-3">
    ...
    <a
      class="inline-flex h-11 items-center rounded-xl bg-slate-900 px-5 text-sm font-semibold text-white transition hover:bg-slate-700"
      href="/contact"
    >
      Start a project
    </a>
