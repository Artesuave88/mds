<script>
  ...
  $: textareaClass = cn(
    "w-full rounded-lg border bg-brand-surface/85 px-4 py-3 text-sm text-brand-text shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] outline-none transition placeholder:text-brand-text/45 focus-visible:ring-2 focus-visible:ring-brand-accent/30 focus-visible:ring-offset-1",
